Public Class Form3
    ...
    Private Sub BtnHitung_Click(sender As Object, e As EventArgs) Handles BtnHitung.Click
        Try
            Dim barisMatriks1 As Integer = TextBox1M.Lines.Count
            Dim kolomMatriks1 As Integer = TextBox1M.Lines.ElementAt(0).Split(" ").Length
            Dim barisMatriks2 As Integer = TextBox1M.Lines.Count
            Dim kolomMatriks2 As Integer = TextBox1M.Lines.ElementAt(0).Split(" ").Length
        ...
        If (Me.cekKolom) Then
            For baris As Integer = 0 To baris1 - 1
                For kolom As Integer = 0 To kolom1 - 1
                    nilai1(baris, kolom) = TextBox1M.Lines.ElementAt(baris).Split(" ").ElementAt(kolom)
                    nilai2(baris, kolom) = TextBox2M.Lines.ElementAt(baris).Split(" ").ElementAt(kolom)
                Next
            Next
        End If
    End Sub
    ...
    Private Sub cek(ByVal baris1 As Integer, baris2 As Integer, kolom1 As Integer, kolom2 As Integer)
        ...
        For baris = 0 To baris1 - 2
            If (TextBox1M.Lines.ElementAt(baris).Split(" ").Length <> TextBox1M.Lines.ElementAt(baris + 1).Split(" ").Length) Then
                tmp = False
            End If
        Next
        For baris = 0 To baris2 - 2
            If (TextBox2M.Lines.ElementAt(baris).Split(" ").Length <> TextBox2M.Lines.ElementAt(baris + 1).Split(" ").Length) Then
                tmp = False
            End If
        Next
        If (tmp = False) Then
            Me.cekKolom = False
            Convert.ToInt32(TextBox1M.Text)
            Convert.ToInt32(TextBox2M.Text)
            MsgBox("Matriks Tidak Valid")
        ElseIf (baris1 = baris2 And kolom1 = kolom2) Then
            Me.cekKolom = True
        Else
            Me.cekKolom = False
            MsgBox("Baris da Kolom Semua Matriks Harus Sama")
        End If
    End Sub
